...
#changes made directly in acton package directory
from packages.acton.plb.datamodules.data_transform import SkeletonTransform
...
class KITSeqDataModule(LightningDataModule):
    ...
    def __init__(
        ...
        self.dataset = KITSkeletonDataset(data_dir=DATA_DIR, split=SPLIT)
